...
public class Console {
    ...
    private Console showMainMenu(Console console) throws IOException {
        ...
        int curInd = 0;//variable to store current index
            ...
            switch (selection) {
                case 1:
                    ...
                    * */
                    ...
                    FileReader newFile;
                    try{
                        newFile = new FileReader("grades.txt");
                        ...
                        try {
                            ...
                            System.out.println("File not found. Returning to the previous menu.");
                        }
        ...
        do {
            ...
            switch (selection) {
                case 1:
                    ...
                    while (weightIncomplete){
                        ...
                        if (totalW == 100) {
                            ...
                            System.out.println("Total number of weights is not set or less than 0. Please try again.");
                    ...
                    GradeItems gradeItem = new GradeItems(finalExamW, midtermExamW, projectW, hwW, quizW, participationW, extraPointsW, classN);
                    gradeItems.add(gradeItem);

                    //calculating total score based on weights
                    //public void calculateTotalWeightedScore(ArrayList<Roster> roster, ArrayList<GradeItems> gradeItems, ArrayList<Student> students) {
                ...
                case 6:
                    ...
                    return console.showMenu4(console);
                case 7: return console.showMainMenu(console);
                default:
                    System.out.println("Invalid selection. Please try again.\n");
            }
        } while (selection != 6);
